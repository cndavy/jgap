 ...
 * input parameter t and two output values F1 and F2, with F1 = t*t
 * and F2 = (t - 2)*(t - 2). The input value is restricted from -10 to 10.
...
public class MultiObjectiveExample {
  ...
  public void execute()
    ...
    // -----------------------------------
    System.out.println("Formula F1(x) = x^2");
    System.out.println("Formula F2(x) = (x-2)^2");
